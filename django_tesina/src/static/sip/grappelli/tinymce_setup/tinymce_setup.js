...
function CustomFileBrowser(field_name, url, type, win) {
    ...
    var cmsURL = '/admin-staff/filebrowser/browse/?pop=2';
...
tinyMCE.init({
    ...
    plugins: 'advimage,advlink,fullscreen,paste,media,searchreplace,grappelli,table',
    // directionality : "rtl",
    ...
    theme_advanced_buttons2: 'search,|,pasteword,media,charmap,|,code,|,table,|,cleanup,grappelli_documentstructure,|,forecolor',
